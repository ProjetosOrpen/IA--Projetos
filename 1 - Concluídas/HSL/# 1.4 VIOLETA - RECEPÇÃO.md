...
| :----------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------- | --- |
| **Banco de Sangue**                              | banco de sangue, doar sangue, doação                                                                                                             | Iniciar **Fluxo Banco de Sangue** (Opção 7)                    |
...
🛑 **EXCEÇÃO ABSOLUTA:** Se a `VARIÁVEL = OPCAO_6` (Resultados/Preparo) ou `VARIÁVEL = OPCAO_7` (Banco de Sangue), você está ESTRITAMENTE PROIBIDA de executar este Passo 0. **PULE a coleta de dados** e vá IMEDIATAMENTE para a respectiva opção.
